...
class PlacementsControllerTest < ActionController::TestCase
  ...
  test "should create placement" do
    assert_difference('Placement.count') do
      post :create, placement: { ad_unit_id: @placement.ad_unit_id, epom_id: @placement.epom_id, name: @placement.name, size_height: @placement.size_height, size_width: @placement.size_width, type: @placement.type, zone_id: @placement.zone_id }
    end
  ...
  test "should update placement" do
    patch :update, id: @placement, placement: { ad_unit_id: @placement.ad_unit_id, epom_id: @placement.epom_id, name: @placement.name, size_height: @placement.size_height, size_width: @placement.size_width, type: @placement.type, zone_id: @placement.zone_id }
    assert_redirected_to placement_path(assigns(:placement))
  end
